...
[TestFixture]
public class Test_SignalRSink_Accessor
{
            ...
            .ConfigureServices(services =>
            {
                ...
                services.AddSerilog((serviceProvider, loggerConfiguration) =>
                    loggerConfiguration.WriteTo.SignalR<TestSerilogHub>(
                        serviceProvider,
                        (context, message, _) => context.Clients.All.SendCoreAsync("Receive", [message])));
            })
            .Configure(app =>
            {
                app.UseRouting();
    ...
    [Test]
    public async Task SignalR_THub_Accessor_Emit_Sends_Message_To_Hub()
    {
        // Arrange
